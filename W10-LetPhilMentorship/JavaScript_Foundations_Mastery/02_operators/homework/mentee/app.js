...
const gameName = "Space Blaster"; // the name should be fixed
const playerName = "Arnot"; // the name should be fixed
let playerScore = 0; // general goal of games to get score
let highScore = 850; // can be changed by new player
const pointsPerKill = 25; // I expect it will be multiplied but not modified
let livesRemaining = 3; // Player could lose life
...
let totalEarned = pointsPerKill * 6;
...
console.log(livesRemaining > 0); //true means 1 is bigger than 0
...
//accuractPercent has 1 decimal because the value is 77.5%
//we can cast the floating number or we can multiply it by 100